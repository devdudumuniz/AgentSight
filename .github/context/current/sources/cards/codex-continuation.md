---
title: Prompt de continuidade do Codex
type: Operational
---

- localização: `docs/codex-continuation-prompt.md`
- resumo: priorização funcional e validação mínima esperada para evolução do projeto.
