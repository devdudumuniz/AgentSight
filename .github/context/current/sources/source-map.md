...
| Fonte | Domínio | Módulo | Decisão | Runbook | Tema |
| --- | --- | --- | --- | --- | --- |
| `docs/architecture.md` | agent-runtime | capture/policy/evidence | ADR-0001 | build | arquitetura |
| `docs/privacy-threat-model.md` | security | policy/redact | - | troubleshooting | segurança |
